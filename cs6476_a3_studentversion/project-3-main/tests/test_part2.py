...
from vision.part2_fundamental_matrix import (
    standardize_points,
    denormalize_fundamental_matrix,
...
def test_compute_fundamental_matrix():
    ...
    F_student = compute_fundamental_matrix(points1, points2)
...
def test_standardize_points():
    ...
    student_normalized_points, student_T = standardize_points(points_input)
...
def test_denormalize_fundamental_matrix():
    """
    ...
    student_unnormalized_F = denormalize_fundamental_matrix(F, T_a, T_b)
