...
def get_optimizer(
    ...
    learning_rate = config.get("lr", 1e-3) # determine how larger for each step
    weight_decay = config.get("weight_decay", 1e-5) # tune performance between unfitted and over-fitting 
